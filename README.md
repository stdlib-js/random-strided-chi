...
```javascript
chi = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/random-strided-chi@v0.1.1-umd/browser.js' )
```
...
[test-image]: https://github.com/stdlib-js/random-strided-chi/actions/workflows/test.yml/badge.svg?branch=v0.1.1
[test-url]: https://github.com/stdlib-js/random-strided-chi/actions/workflows/test.yml?query=branch:v0.1.1
